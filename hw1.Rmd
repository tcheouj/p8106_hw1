...
With the lambda that minimizes MSE, there are 37 predictors excluding the intercept. With the smallest lambda within 1 SE, there are 30 predictors, which varies slightly with the `caret` model of 29 predictors. 
